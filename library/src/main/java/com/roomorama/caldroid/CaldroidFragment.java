...
public class CaldroidFragment extends DialogFragment {
    ...
    // patch cafedered
    private TextView bigDayTextView;
    ...
    // patch cafedered
    public final static String SHOW_BIG_DAY = "showBigDay";
    public final static String BUTTONS_ENABLED = "buttonsEnabled";
    ...
    // patch cafedered
    protected boolean showBigDay = false;
			...
			dateItemClickListener = new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					if (caldroidListener != null) {
                        ...
                        if (showBigDay && date != null) {
                            TextView bigDay = (TextView) getView()
                                    .findViewById(R.id.big_day_view);
                            bigDay.setText(new SimpleDateFormat("dd")
                                    .format(date));
                        }
	...
	protected void retrieveInitialArgs() {
		...
		if (args != null) {
            ...
            // Get show big day
            showBigDay = args.getBoolean(SHOW_BIG_DAY, false);
            buttonsEnabled = args.getBoolean(BUTTONS_ENABLED, false);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // patch cafedered
        if (showBigDay) {
            TextView bigDay = (TextView) view.findViewById(R.id.big_day_view);
            bigDay.setVisibility(View.VISIBLE);
            bigDay.setText(""
                    + Calendar.getInstance().get(Calendar.DAY_OF_MONTH));
        }

        if (buttonsEnabled) {
            View confirmButtons = view.findViewById(R.id.confirm_buttons);
            confirmButtons.setVisibility(View.VISIBLE);
            Button cancelButton = (Button) view.findViewById(R.id.cancel_btn);
            cancelButton.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    caldroidListener.onSelectDate(null, v);
                    dismiss();
                }
            });
            Button confirmButton = (Button) view.findViewById(R.id.confirm_btn);
