...
@Activity(
layout = R.layout.activity_calendar,
        displayAppIcon = true,
        fragmentContainerView = R.id.container,
        initFragment = CalendarFragment.class,
        rootView = R.id.container,
        title = R.string.activity_calendar_title)
public class CalendarActivity extends BaseSupportActivity {
