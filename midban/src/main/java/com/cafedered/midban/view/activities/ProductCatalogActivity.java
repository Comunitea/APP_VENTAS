...
@Activity(layout = R.layout.activity_product_catalog,
        rootView = R.id.container,
        displayAppIcon = true,
        title = R.string.activity_product_catalog_title,
        initFragment = ProductCatalogFragment.class,
        fragmentContainerView = R.id.container)
public class ProductCatalogActivity extends BaseSupportActivity {
