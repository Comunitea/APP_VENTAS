...
import com.cafedered.midban.view.fragments.TaskDetailFragment;

@Activity(displayAppIcon = true,
        fragmentContainerView = R.id.container,
        initFragment = TaskDetailFragment.class,
        layout = R.layout.activity_task_detail,
        rootView = R.id.container,
        title = R.string.activity_task_detail_title)
public class TaskDetailActivity extends BaseSupportActivity {
